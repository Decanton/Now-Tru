...
function AppointmentForm() {
  ...
  const [appointmentTime, setAppointmentTime,formErrorstclientNumber] = useState("default");
  ...
  return (
    <div className="appointment-form-section">
        ...
        <form className="form-content" onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <input
              ...
              required
            />
            {formErrorstclientNumber && <p className="error-message">{formErrorstclientNumber}</p>}
          </label>
          ...
          <label>
            ...
            >
              ...
              <option value="private">I will inform Driver only</option>
            </select>
      ...
      <div className="legal-footer">
        <p>© 2024 Tru-Ride. All rights reserved.</p>
      </div>
